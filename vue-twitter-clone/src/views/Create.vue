<template>
    <div>
        ...
        <form v-if="creating" @submit.prevent="addTweet">
        ...
        <div v-else>
            <p>Thank you for submitting Tweet! We will respond shortly.</p>
            <p><a @click="toggleForm" href="#">Submit another Tweet</a></p>
        </div>
    </div>
</template>
